...
func InitializeElevator() int {
	...
	go PollAllInputs(externalButtonChannel, internalButtonChannel)
	go InputHandler(externalButtonChannel, internalButtonChannel)
...
func InputHandler(externalButtonChannel, internalButtonChannel chan int){
	for{
		select{
